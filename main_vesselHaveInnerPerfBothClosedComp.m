...
variant_n1 = [20];              %variant_n = [6,6];sectionNum1 =[1,6];%对应孔1的组数sectionNum2 =[1,1];%对应孔2的组数
...
for i = 1:length(para)
    ...
    calcDatas{dataCount,1} = sprintf('入口内插孔管两端堵死缓冲罐,n1:%g,n2:%g',variant_n1(i),variant_n2(i));
    calcDatas{dataCount,2} = X;
    ...
    calcDatas{dataCount,1} = sprintf('入口内插孔管开口缓冲罐,n1:%g,n2:%g',variant_n1(i),variant_n2(i));
    calcDatas{dataCount,2} = X;
