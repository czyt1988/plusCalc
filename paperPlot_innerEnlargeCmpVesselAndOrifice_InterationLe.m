...
inputData = [...
    ...
    %L1  ,L2,Dpipe,Dv ,l   ,Lv   ,Linner    ,Le   ,Dr1 ,  Dr2 , Din 
    3.35,10,0.106,0.45,0.01,1.18 ,0.591     ,0.05  ,0.106/2, 0.106,  0.106
    3.35,10,0.106,0.45,0.01,1.18 ,0.591     ,0.25  ,0.106/2, 0.106,  0.106
    3.35,10,0.106,0.45,0.01,1.18 ,0.591     ,0.45  ,0.106/2, 0.106,  0.106
];%LrLc不能为零
...
for i = 1:size(inputData,1)
    name{i} = sprintf('Le:%g',inputData(i,8));
    %desp{i} = sprintf('L1:%g,L2:%g,Dpipe:%g,Dv:%g,l:%g,Lv:%g,Linner:%g,Le:%g,Dr1:%g,Dr2:%g,Din:%g'...
    ...
    para(i).Le = inputData(i,8);%逐渐扩径管长度
    para(i).Dr1 = inputData(i,9);%逐渐扩径管入口管径
    para(i).Dr2 = inputData(i,10);%逐渐扩径管出口管径
...
for i = 1:length(para)
    ...
    [pressure1,pressure2] = ...
        innerEnlargeVesselPulsationCalc(massFlowE,Fre,time,...
        para(i).L1,para(i).L2,...
        para(i).Lv,para(i).l,para(i).Dpipe,para(i).Dv,...
        para(i).Linner,para(i).Le,...
