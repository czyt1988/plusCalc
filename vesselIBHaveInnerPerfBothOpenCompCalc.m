function [pressure1,pressure2] = vesselIBHaveInnerPerfBothOpenCompCalc(massFlowE,Frequency,time ...
...
for i = 1:length(Frequency)
    ...
    matrix_Mv{count} = vesselIBHaveInnerPerfBothOpenCompTransferMatrix(Dpipe,vhpicStruct.Dv,vhpicStruct.l,vhpicStruct.Lv...
