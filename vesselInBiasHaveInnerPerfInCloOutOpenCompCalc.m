function [pressure1,pressure2] = vesselInBiasHaveInnerPerfInCloOutOpenCompCalc(massFlowE,Frequency,time ...
...
for i = 1:length(Frequency)
    ...
    matrix_Mv{count} = vesselIBHaveInnerPerfInCloOutOpenCompTransferMatrix(Dpipe,vhpicStruct.Dv,vhpicStruct.l,vhpicStruct.Lv1,vhpicStruct.Lv2...
