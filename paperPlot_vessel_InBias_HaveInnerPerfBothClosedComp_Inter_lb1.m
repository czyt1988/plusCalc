...
variant_lp1 = [0.16];
variant_lp2 = [0.07];
variant_lb1 = [0.02;0.06;0.12;0.18;0.24;0.30;0.36];%[0.01;0.06;0.11;0.16;0.21;0.26;0.31];
...
for i = 1:length(variant_lb1)     
    ...
    para(i).vhpicStruct.Lv1 = 0.44;%0.66；%0.84;%para(i).vhpicStruct.Lv./2;%缓冲罐腔1总长
    ...
    para(i).vhpicStruct.lb2 = para(i).vhpicStruct.Lout-variant_lb1(i)-variant_lp2;%0.03;%para(i).vhpicStruct.Lout-variant_lb2(i)-variant_lp2;
