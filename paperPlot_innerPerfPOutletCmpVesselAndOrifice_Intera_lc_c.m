...
inputData = [...
    ...
    3.35,10,0.106,0.45,0.01,1.18 ,0.005 ,0.005  ,0.013, 16,  0.25, 0.25, 0.0938, 0.106/2
    3.35,10,0.106,0.45,0.01,1.18 ,0.05 ,0.005  ,0.013, 16,  0.25, 0.25, 0.0938, 0.106/2
    3.35,10,0.106,0.45,0.01,1.18 ,0.1 ,0.005  ,0.013, 16,  0.25, 0.25, 0.0938, 0.106/2
    3.35,10,0.106,0.45,0.01,1.18 ,0.2 ,0.005  ,0.013, 16,  0.25, 0.25, 0.0938, 0.106/2
];%LrLc不能为零
...
for i = 1:size(inputData,1)
    name{i} = sprintf('lc:%g,n:g%',inputData(i,7),inputData(i,10));
