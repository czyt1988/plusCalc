function [pressure1,pressure2] = innerEnlargeVesselPulsationCalc(massFlowE,Frequency,time ...
    ,L1,L2,Lv,l,Dpipe,Dv,Linner,Le,Dr1,Dr2...
...
for i = 1:length(Frequency)
    ...
    matrix_Mv{count} = vesselHaveInnerEnlargeTransferMatrix(Lv,l,Dv,Dpipe,Linner,Le,Dr1,Dr2 ...
