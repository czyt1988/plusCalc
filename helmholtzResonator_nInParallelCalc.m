function [pressure1,pressure2] = helmholtzResonator_nInParallelCalc(massFlowE,Frequency,time ...
    ,L1,L2,Dpipe,V,lv,lc,dp,n,la1,la2 ...
...
for i = 1:length(Frequency)
    ...
    matrix_Mv{count} = vesselHaveMulHelsParallelInletTransferMatrix(V,lv,lc,dp,n,la1,la2,Dpipe...
