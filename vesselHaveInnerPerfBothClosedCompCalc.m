function [pressure1,pressure2] = vesselHaveInnerPerfBothClosedCompCalc(massFlowE,Frequency,time ...
...
for i = 1:length(Frequency)
    ...
    matrix_Mv{count} = vesselHaveInnerPerfBothClosedCompTransferMatrix(Dpipe,vhpicStruct.Dv,vhpicStruct.l,vhpicStruct.Lv...
