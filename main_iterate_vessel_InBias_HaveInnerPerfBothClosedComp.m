...
variant_n1 = [5:50];              %variant_n = [6,6];sectionNum1 =[1,6];%对应孔1的组数sectionNum2 =[1,1];%对应孔2的组数
...
for i = 1:iterateSize
    ...
    para(i).vhpicStruct.dp = 0.013/3;%开孔径
    ...
    para(i).vhpicStruct.lv1 = para(i).vhpicStruct.Lv./2-232;%232
