function [pressure1,pressure2] = helmholtzResonator_nInSeriesCalc(massFlowE,Frequency,time ...
    ,L1,L2,Dpipe,V,lv,lc,dp,la1,la2,la ...
     ,sectionL1,sectionL2,varargin)
%亥姆霍兹共鸣器传递矩阵，将沿轴线的多个开孔的孔管等效为亥姆霍兹共鸣器时，单独进行亥姆霍兹共鸣器的并联计算
% lv 共鸣器长
% lc 共鸣器连接管长
% Dp 共鸣器连接管直径             
%       __________                
...
for i = 1:length(Frequency)
    ...
    matrix_Mv{count} = vesselHaveMulHelsSeriesInletTransferMatrix(V,lv,lc,dp,la1,la2,la,Dpipe ...
