function [pressure1,pressure2] = vesselHavePerfInletCompOpenCalc(massFlowE,Frequency,time ...
...
for i = 1:length(Frequency)
    ...
    matrix_Mv{count} = vesselHavePerfInletCompOpenTransferMatrix(Dpipe,vhpicStruct.Dv,vhpicStruct.l,vhpicStruct.Lv...
