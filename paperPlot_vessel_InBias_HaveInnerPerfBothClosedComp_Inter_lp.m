...
variant_dp2 = [0.013];
variant_Din = [0.098/2];
variant_lp1 = [0.08;0.1;0.12;0.14;0.16;0.20];
variant_lp2 = [0.08;0.1;0.12;0.14;0.16;0.20];
...
for i = 1:length(variant_lp1)     
    ...
    para(i).vhpicStruct.la2 = para(i).vhpicStruct.Lin-para(i).vhpicStruct.la1-para(i).vhpicStruct.lp1;
