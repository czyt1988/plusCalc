function M = vesselHavePerfInletBaffleTransferMatrix(Dpipe,Dv,l,Lv,...
...
Mv = havePerforatedPipeInletBaffleTransferMatrix(a,k,Dv,Lv,...
    lc,dp,lp1,n1,la1,la2,Din,xSection1,optDamping,optMach);
M = M2 * Mv * M1;
end
function M = havePerforatedPipeInletBaffleTransferMatrix(a,k,Dv,Lv ...
    ,lc,dp,lp1,n1,la1,la2,Din,xSection1,optDamping,optMach)
%缓冲罐内入口连接孔管,开孔个数不足以等效为亥姆霍兹共鸣器
%      L1     l                 Lv              l    L2  
%              _________________________________        
