...
variant_n1 = [20,20,20,20];              %variant_n = [6,6];sectionNum1 =[1,6];%对应孔1的组数sectionNum2 =[1,1];%对应孔2的组数
sectionNum1 =[1,1,1,1];%对应孔1的组数
sectionNum2 =[1,1,1,1];%对应孔2的组数
variant_n2 = [20,20,20,20];
variant_dp = [0.004,0.007,0.010,0.013];
% variant_Lv1 = 0.568:0.02:0.84;
calcDatas = {};


for i = 1:length(variant_dp)     
    para(i).opt = opt;
    para(i).L1 = 1.5;%L1(m)
    para(i).L2 = 6;%L2（m）长度
    ...
    para(i).vhpicStruct.dp = variant_dp(i);%开孔径
...
%     para(i).vhpicStruct.lb1 = 0.06;
    ...
    para(i).vhpicStruct.bp1 = 0.1;%开孔率
    para(i).vhpicStruct.bp2 = 0.1;%开孔率
    para(i).vhpicStruct.lp1 = variant_n1(i).*(para(i).vhpicStruct.dp)^2./(4.*para(i).vhpicStruct.Din.*para(i).vhpicStruct.bp1);
    para(i).vhpicStruct.lp2 = variant_n2(i).*(para(i).vhpicStruct.dp)^2./(4.*para(i).vhpicStruct.Din.*para(i).vhpicStruct.bp2);
    para(i).vhpicStruct.la2 = para(i).vhpicStruct.Lin-para(i).vhpicStruct.lp1-para(i).vhpicStruct.la1;%孔管
    para(i).vhpicStruct.lb1 = para(i).vhpicStruct.Lout-para(i).vhpicStruct.lp2-para(i).vhpicStruct.lb2;
    ...
    name{i} = sprintf('dp:%g',variant_dp(i));
end
...
for i = 1:length(para)
    ...
    calcDatas{dataCount,1} = sprintf('入口偏置内插孔管两端堵死缓冲罐,dp:%g',variant_dp(i));
    calcDatas{dataCount,2} = X;
