...
%缓冲罐内入口连接孔管,开孔个数不足以等效为亥姆霍兹共鸣器.Lout部分为内插开口管，不开孔
%      L1     l                 Lv              l    L2  
...
% variant_n1 = [7,14,21,28];              %variant_n = [6,6];sectionNum1 =[1,6];%对应孔1的组数sectionNum2 =[1,1];%对应孔2的组数
...
for i = 1:length(para)
    ...
    [pressure1,pressure2] = ...
        vesselHavePerfInletNoneOutCalc(massFlowE,Fre,time,...
