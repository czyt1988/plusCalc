function M = vesselHavePerfInletNoneOutTransferMatrix(Dpipe,Dv,l,Lv,...
    lc,dp,lp1,n1,la1,la2,Din,Lout,xSection1,varargin)
...
Mv = havePerforatedPipeInletNoneOutTransferMatrix(a,k,Dv,Lv,...
    lc,dp,lp1,n1,la1,la2,Din,Lout,xSection1,optDamping,optMach);
M = M2 * Mv * M1;
end
function M = havePerforatedPipeInletNoneOutTransferMatrix(a,k,Dv,Lv ...
    ,lc,dp,lp1,n1,la1,la2,Din,Lout,xSection1,optDamping,optMach)
