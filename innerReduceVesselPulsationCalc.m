function [pressure1,pressure2] = innerReduceVesselPulsationCalc(massFlowE,Frequency,time ...
    ,L1,L2,Lv,l,Dpipe,Dv,Linner,Lr,Dr1,Dr2...
...
for i = 1:length(Frequency)
    ...
    matrix_Mv{count} = vesselHaveInnerReduceTransferMatrix(Lv,l,Dv,Dpipe,Linner,Lr,Dr1,Dr2 ...
