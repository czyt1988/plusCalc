...
variant_n1 = [16,24,32,40,56,72,80,88];%按实验一圈8个孔
sectionNum1 =[1,1,1,1,1,1,1,1];%对应孔1的组数
sectionNum2 =[1,1,1,1,1,1,1,1];%对应孔2的组数
variant_n2 = [16,24,32,40,56,72,80,88];%[72,72,72,72,72,72];
variant_lp2 = [0.16,0.16,0.16,0.16,0.16,0.16,0.16,0.16];
