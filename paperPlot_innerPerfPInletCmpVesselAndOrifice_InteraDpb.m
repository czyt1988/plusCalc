...
%当孔管与入口管紧密连接，上述结构等效为亥姆霍兹共鸣器与膨胀腔的串连
% lin 孔管入口长（共鸣器直径）
% lout孔管出口段长
% lc 孔管壁厚
% dp 孔管一个孔的孔径
...
inputData = [...
    ...
    3.35,10,0.106,0.45,0.01,1.18 ,0.005,0.591  ,0.0265,4,  0.2,  0.2,  0.0938, 0.106
    3.35,10,0.106,0.45,0.01,1.18 ,0.005,0.591  ,0.0265,8,  0.2,  0.2,  0.0938, 0.106
    3.35,10,0.106,0.45,0.01,1.18 ,0.005,0.591  ,0.0265,12,  0.2,  0.2,  0.0938, 0.106
    3.35,10,0.106,0.45,0.01,1.18 ,0.005,0.591  ,0.0265,16,  0.2,  0.2,  0.0938, 0.106
];%LrLc不能为零
...
for i = 1:size(inputData,1)
    name{i} = sprintf('n:%g',inputData(i,10));
