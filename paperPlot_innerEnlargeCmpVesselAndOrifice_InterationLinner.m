...
inputData = [...
    ...
    3.35,10,0.106,0.45,0.01,1.18 ,0.4     ,0.05  ,0.106/2, 0.106,  0.106
    3.35,10,0.106,0.45,0.01,1.18 ,0.6     ,0.05  ,0.106/2, 0.106,  0.106
    3.35,10,0.106,0.45,0.01,1.18 ,0.8     ,0.05  ,0.106/2, 0.106,  0.106
];%LrLc不能为零
...
for i = 1:size(inputData,1)
    name{i} = sprintf('Linner:%g',inputData(i,7));
