function [pressure1,pressure2] = vesselHaveInnerPerfInCloOutOpenCompCalc(massFlowE,Frequency,time ...
...
for i = 1:length(Frequency)
    ...
    matrix_Mv{count} = vesselHaveInnerPerfInCloOutOpenCompTransferMatrix(Dpipe,vhpicStruct.Dv,vhpicStruct.l,vhpicStruct.Lv...
