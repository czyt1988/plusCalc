function [pressure1,pressure2] = vesselHavePerfInletCompNoBaffleCompCalc(massFlowE,Frequency,time ...
...
for i = 1:length(Frequency)
    ...
    matrix_Mv{count} = vesselHavePerfInletCompNoBaffleTransferMatrix(Dpipe,vhpicStruct.Dv,vhpicStruct.l,vhpicStruct.Lv...
