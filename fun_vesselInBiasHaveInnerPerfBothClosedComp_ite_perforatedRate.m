function [resN1,resLp1,resDin,resDp1,resOneVessel,expTheoryResult,expOneVessel] = fun_vesselInBiasHaveInnerPerfBothClosedComp_ite_perforatedRate()
...
expOneVessel = temp(1:2,:);
expTheoryResult = cellPush2Bottom(temp(1,:),temp(3,:));
